...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.minhaLista_listWidget, 1, 0, 1, 4)
        ...
        self.pushButton_DeleteAll.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_DeleteAll.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("assets/delete_all.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_DeleteAll.setIcon(icon3)
        self.pushButton_DeleteAll.setIconSize(QtCore.QSize(32, 32))
        self.pushButton_DeleteAll.setObjectName("pushButton_DeleteAll")
        self.gridLayout.addWidget(self.pushButton_DeleteAll, 0, 3, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("assets/edit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_Update.setIcon(icon4)
        self.pushButton_Update.setIconSize(QtCore.QSize(32, 32))
        self.pushButton_Update.setObjectName("pushButton_Update")
        self.gridLayout.addWidget(self.pushButton_Update, 0, 1, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("assets/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
